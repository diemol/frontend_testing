...
BookingConfirmationPage = function BookingConfirmationPage(driver) {
    this.driver = driver;
    this.payOnArrivalLocator = By.css("button[class*='btn-arrival']");
    this.paymentStatus = By.css("b.text-warning.wow.flash.animted");
};

BookingConfirmationPage.prototype.payOnArrival = function() {
    this.driver.wait(until.elementLocated(this.payOnArrivalLocator, 10000));
    this.driver.findElement(this.payOnArrivalLocator).click();
