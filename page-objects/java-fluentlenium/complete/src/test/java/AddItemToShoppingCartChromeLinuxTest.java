...
public class AddItemToShoppingCartChromeLinuxTest extends FluentTestNg {

    private static final Logger LOG = Logger.getLogger(AddItemToShoppingCartChromeLinuxTest.class.getName());
