...
var testBrowsers = require('./base').testBrowsers;
var formatDate = require('./base').formatDate;

describe('Hotel Test', function() {
    this.timeout(60000);

    testBrowsers().forEach(function(testBrowser) {
        it('Book hotel and select pay at hotel should leave booking reserved. ' + testBrowser.browser + ", " +
            testBrowser.platform, function(done) {

            var driver = createDriver(this._runnable.title, testBrowser.browser, testBrowser.platform);
