### Slightly more complex WebDriver examples in Java and JavaScript

These are a couple of lightly more complex examples, which basically test two common scenarios:
* A user registering to a website.
* A hotel room reservation.

Implemented in [Java with TestNG](https://github.com/diemol/frontend_testing/tree/master/more-examples/java-testng) and [JavaScript with Mocha and Chai](https://github.com/diemol/frontend_testing/tree/master/more-examples/js-mocha-chai).
