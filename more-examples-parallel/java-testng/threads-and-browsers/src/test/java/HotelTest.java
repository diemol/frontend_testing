...
public class HotelTest extends BaseTest {
    ...
    public void bookHotelAndSelectPayAtHotelShouldLeaveBookingReserved(String browserType, Platform platform, 
            Method method) throws InterruptedException, MalformedURLException {
